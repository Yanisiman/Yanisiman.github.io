...
<h2>Filiga Inspiration Games</h2>
<hr/>

<div class="paragraph">
<p>Filiga Inspiration Games (ou FIG) est un groupe formé de quatre étudiants de l'EPITA: Tanguy Desgouttes, Yanis Chaabane, Marc-emmanuel Raiffe et Jordan Failloux. FIG est spécialisé dans la création de jeux vidéos, nous travaillons actuellement exclusivement sur le jeu vidéo "Tales of the Apocalypse" (abrégé TotA). Nous espérons combler notre manque d'expérience dans le domaine par notre détermination au travail et nos connaissances dans le domaine du jeu vidéo. La création de notre groupe se repose sur un mélange harmonieux entre une bonne entente déjà existante, un mélange de différentes compétences et expériences dans le domaine du jeu vidéo et un intérêt partagé pour le concept de TotA.</p>
<p>Le nom de notre groupe, Filiga Inspiration Games, provient d'une réflexion sur nos forces potentielles: la diligence au travail ("Filiga" signifie "diligent" en Samoan) et nos connaissances de différents jeux dont nous allons nous inspirer ("Inspiration"). Enfin, "Games" représente simplement le domaine dans lequel notre groupe a décidé de se spécialiser.</p>
<p>Le logo de notre groupe est la représentation abstraite d'une figue, provenant de l'abréviation FIG du nom de notre groupe. La figue apparaît comme étant pixelisé reflétant la direction artistique de TotA tournée alors vers un style cubique.</p>
</div>

<h2>Tales Of The Apocalypse</h2>
<hr class="sub" />
<div class="paragraph">
<p>Tales of the Apocalyps eest un jeu vidéo en 3D visant à recréer une expérience d’un groupe de survivants lors d’une apocalypse. Le joueur aura alors le contrôle total de l’ensemble des membres du groupe et aura pour tâche de les faire survivre. Chaque survivant est unique et possède des traits, des compétences et des caractéristiques propre à lui représentant ses forces et ses faiblesses. TotA n’est ni un jeu de stratégie compétitif ni un simulateur, mais est avant tout un générateur d’histoire, ainsi l’intérêt premier du jeu n’est pas de gagner mais d’assister aux différents événements, qu’ils soient épiques, comiques, tragiques ou dramatiques, vécus par le groupe de survivants.</p>
<p>Tales of the Apocalypse} se présente donc comme un projet ambitieux mélangeant différents éléments de jeux populaires. Il se démarque par une génération procédurale du monde en 3D, des personnages distincts et la présence d'événement afin de produire une histoire marquante chez le joueur.</p>
</div>

<h3>Fonctionnalités jouables</h3>
<hr class="sub" />

<h4>Les survivants</h4>
<div class="paragraph">
<p>Pour permettre l'attachement du joueur à ses survivants, chaque survivant se doit d'être unique. Ainsi, il a un nom, un âge, un sexe et surtout, des attributs et des compétences.</p>
...
<h4>Rythme et dramaturgie</h4>
<div class="paragraph">
<p>Le maintien d'un rythme est crucial. Il existe de nombreuse façons d'empêcher un jeu répétitif et monotone (cf. Project Zomboid).</p>

<ul class="liste">
	<li>
	Evénement: A la manière des événements dans <i>Rimworld</i>, les événements dans TotA seront à intervalle plus ou moins régulier et peuvent être positif comme négatif, par exemple une vague de froid, une attaque de bandit ou même l'apparition d'une horde de zombie.
	</li>
	<li>
